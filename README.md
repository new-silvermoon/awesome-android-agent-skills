...
*   **[KMP Payment Architecture](.github/skills/architecture/kmp-payment-architecture/SKILL.md)** - **Kotlin Multiplatform** payment feature architecture using **Koin**, MVI Reducer, and platform bridge interfaces.
